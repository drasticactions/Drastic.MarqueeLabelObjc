...
namespace Drastic.MarqueeLabelObjc
{
    ...
    interface MarqueeLabel : ICAAnimationDelegate
    {
        ...
        NativeHandle Constructor(CGRect frame, nfloat pixelsPerSec, nfloat fadeLength);
        ...
        NativeHandle Constructor(CGRect frame, double scrollDuration, nfloat fadeLength);
        ...
        // @property (assign, nonatomic) CGFloat continuousMarqueeExtraBuffer __attribute__((deprecated("Use trailingBuffer instead.")));
        ...
        // -(void)resetLabel __attribute__((deprecated("Use resetLabel instead")));
        [Export("resetLabel")]
        void ResetLabel();
        ...
        // +(void)controllerViewAppearing:(UIViewController *)controller __attribute__((deprecated("Use controllerViewDidAppear: instead.")));
        [Static]
